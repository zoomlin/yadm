...
if s:is_dark
	let s:gb.dark0  = ['100D08', 235]	  " 40-40-40
	...
	let s:gb.light0 = ['100D08', 235]	  " 40-40-40
...
call s:HL('ErrorMsg',	'light0', 'red', 'bold')
" More prompt: -- More --
...
call s:HL('FoldColumn', 'medium', 'dark0')
...
call s:HL('Error', 'light0', 'red', 'bold')
...
if has("spell")
	...
	" Not recognized word
	call s:HL('SpellBad',	'red', 'none', 'undercurl', 'blue')
